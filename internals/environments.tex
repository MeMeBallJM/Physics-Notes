...
\definecolor{terminology_color_background}{HTML}{F9D8DE}
\definecolor{terminology_color_frame}{HTML}{F2ACB8}
\definecolor{terminology_color_title}{HTML}{FFFFFF}
\newtcbtheorem[number within=section]{terminology}{Terminology}
{
  ...
  boxed title style = {colback=terminology_color_frame, sharp corners},
  % Adjust colors
  colback= terminology_color_background,
  colframe= terminology_color_frame,
  coltitle = terminology_color_title,
}{terminology}

% Example environment
\definecolor{example_color_background}{HTML}{D4F7E9}
\definecolor{example_color_frame}{HTML}{84E9BF}
